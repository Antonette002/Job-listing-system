...
<?php $__env->startSection('header-title', 'Company Dashboard'); ?>
        ...
        <ul>
            ...
            <li class="mb-2">
                ...
                <ul id="application-dropdown" class="hidden ml-4 mt-1 space-y-1">
                    <li><a href="<?php echo e(route('applications.index')); ?>" class="block p-1 hover:bg-blue-800 rounded">Review Latest Applications</a></li>
                </ul>
            </li>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\job-listing\resources\views/companies/dashboard.blade.php ENDPATH**/ ?>