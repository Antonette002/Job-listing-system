...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
        <h2 class="text-2xl font-bold text-center text-gray-800 mb-6">Applicant Login</h2>
        ...
        <form method="POST" action="<?php echo e(route('applicant.login')); ?>">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mt-6 text-center">
            ...
            <a href="<?php echo e(route('applicant.register')); ?>"
...
<?php /**PATH C:\xampp\htdocs\job-listing\resources\views/applicants/login.blade.php ENDPATH**/ ?>